...
function new_wpestate_appeareance(){
    ...
    <div class="option_row_explain">'.__('Where to show the sidebar for property post submitted from front end and blog category/archive list.','wpestate').'</div>    
    ...
    <div class="option_row_explain">'.__('What sidebar to show for property post submitted from front end and blog category/archive list.','wpestate').'</div>    
...
if( !function_exists('new_wpestate_advanced_search_settings') ):  
 function new_wpestate_advanced_search_settings(){
    ...
    <div class="option_row_explain">'.__('Disables or enables the display of advanced search over header Google Maps. ','wpestate').'</div>    
   ...
   return;
    print'<div class="estate_option_row">';
        ...
        print '<div id="property_page_design_wrapper">';
                ...
                print '<div id="property_page_sidebar_left" style="display:none;"></div>';
        
                print '<ul id="property_page_content">'. stripslashes($content).'</ul>';
        
                print '<div id="property_page_sidebar_right"></div>';
